...
BASE_STYLE = (
    ...
    "most of the canvas.\n\n"
    "No text or numerals ANYWHERE in the image. This is a hard rule with no "
    "exceptions. Do NOT render: street numbers, house numbers, mailbox "
    "lettering, address plaques, name plaques, \"welcome\" or other door "
    "signs, security-company yard signs, realtor or political signs, "
    "license plates, business names, decorative letters or monograms on "
    "the door or siding, numbers on planters, dates carved into stonework, "
    "or any other letters, words, digits, or symbol-like glyphs. If the "
    "source photograph shows any of the above, omit them entirely rather "
    "than guessing or approximating — never invent text. The rendered home "
    "must be completely free of text and numerals.\n\n"
